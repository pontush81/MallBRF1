...
const stadgarSections: StadgarSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '**Rösträtt:** Varje medlem har en röst, oavsett antal lägenheter.',
  ...
  },
  {
    ...
    body: [
      '**Du som bostadsrättshavare ansvarar för:**',
      '• Ytskikt på väggar, golv och tak',
      '• Innerdörrar, fönsterbeslag, handtag och lås',
      '• Ytterdörrens insida (lås, nycklar, brevinkast)',
      '• El från säkringsskåp och ledningar i lägenheten',
      '• Vitvaror, sanitetsporslin och armaturer',
      '• Brandvarnare',
      '• I våtrum: tätskikt, golvbrunn och tvättmaskin',
      '• I kök: vitvaror, köksfläkt och diskmaskin',
      '**Föreningen ansvarar för:**',
      '• Fastighetens gemensamma delar',
      '• Byggnadens yttre (fasad, tak, trapphus)',
      '• Stamledningar för vatten och avlopp',
      '**Balkong/altan:** Du ansvarar för renhållning och snöskottning.',
    ],
    icon: <HomeIcon />,
    color: bastadTheme.colors.terracotta[500],
  },
  {
    ...
    body: [
      ...
      '• Ändring av ledningar för avlopp, värme, gas eller vatten',
  ...
  },
  {
    ...
    body: [
      ...
      '• Vilken tid den ska pågå',
      '• Till vem lägenheten ska upplåtas',
